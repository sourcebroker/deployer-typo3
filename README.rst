...
=======================
      ...
      .. image:: http://img.shields.io/packagist/v/sourcebroker/deployer-typo3.svg?style=flat
         :target: https://packagist.org/packages/sourcebroker/deployer-typo3
...
3) Remove task "deploy" from your deploy.php. Otherwise you will overwrite deploy task defined in
   ``vendor/sourcebroker/deployer-typo3/deployer/default/deploy/task/deploy.php``. Look at
   ...
   Read https://github.com/sourcebroker/deployer-typo3/discussions/14 to see why updating language labels on
...
This is example of working configuration for TYPO3 13. The aim of ``sourcebroker/deployer-typo3`` is to
...
.. _sourcebroker/deployer-typo3: https://github.com/sourcebroker/deployer-typo3
