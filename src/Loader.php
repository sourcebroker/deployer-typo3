...
namespace SourceBroker\DeployerTypo3;
...
class Loader
{
    public function __construct()
    {
        ...
        new Load([
                ...
                ['path' => 'vendor/sourcebroker/deployer-typo3/deployer/default']
            ]
        );
    }
    ...
    {
        $dir = __DIR__;
        while ((!is_file($dir . '/composer.json') && !is_file($dir . '/root_dir') && !is_file($dir . '/deploy.php')) || basename($dir) === 'deployer-typo3') {
            if ($dir === \dirname($dir)) {
                break;
            }
            $dir = \dirname($dir);
